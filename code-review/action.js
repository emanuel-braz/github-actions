...
function generateMessages(file, chunk, prDetails) {
    const instructionJsonFormat = `Your task is to review pull requests for possible bugs.
You will provide suggestions only if there are issues or bugs in the code, otherwise return an empty array.
Always return suggestions in JSON format: [{"lineNumber":  <line_number>, "reviewComment": "<review comment>"}]`;
