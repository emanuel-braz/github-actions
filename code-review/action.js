...
- NEVER give positive comments or compliments.
- NEVER suggest to consider removing empty line.
- NEVER suggest to consider to remove trailing whitespace
- NEVER suggest to consider adding comment to describe the purpose of methods
- Provide suggestions ONLY if there is an issue that can lead to bugs, otherwise return an empty array.
